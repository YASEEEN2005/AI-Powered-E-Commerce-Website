      ...
      <div className="mx-auto max-w-[1400px] px-6 py-4 flex items-center justify-between">
        ...
        <nav className="hidden items-center gap-8 text-sm font-medium text-slate-800 md:flex">
          <div className="relative group">
            ...
            <div className="invisible absolute left-0 mt-3 w-44 rounded-xl border 
              border-slate-100 bg-white opacity-0 shadow-xl transition-all
              group-hover:visible group-hover:opacity-100 z-50">
              <Link to="/" className="block px-4 py-2 hover:bg-slate-50">Default Home</Link>
              <Link to="/minimal-home" className="block px-4 py-2 hover:bg-slate-50">Minimal Home</Link>
            </div>
          </div>
          ...
          <div className="relative group">
            ...
            <div className="invisible absolute left-0 mt-3 w-44 rounded-xl border 
              border-slate-100 bg-white opacity-0 shadow-xl transition-all
              group-hover:visible group-hover:opacity-100 z-50">
              <Link to="/products" className="block px-4 py-2 hover:bg-slate-50">All Products</Link>
              <Link to="/new-arrivals" className="block px-4 py-2 hover:bg-slate-50">New Arrivals</Link>
              <Link to="/best-sellers" className="block px-4 py-2 hover:bg-slate-50">Best Sellers</Link>
            </div>
          </div>

          <Link to="/recommended" className="hover:text-black">Made for You</Link>
          ...
          <div className="relative group">
            ...
            <div className="invisible absolute left-0 mt-3 w-44 rounded-xl border
              border-slate-100 bg-white opacity-0 shadow-xl transition-all
              group-hover:visible group-hover:opacity-100 z-50">
              <Link to="/about" className="block px-4 py-2 hover:bg-slate-50">About Us</Link>
              <Link to="/faq" className="block px-4 py-2 hover:bg-slate-50">FAQ</Link>
              <Link to="/policy" className="block px-4 py-2 hover:bg-slate-50">Terms & Policy</Link>
            </div>
          </div>
        ...
        <div className="flex items-center gap-3">
          <button className="hidden h-9 w-9 items-center justify-center rounded-full 
            hover:bg-slate-100 md:flex">
            <Search className="h-4 w-4" />
          </button>

          <Link to="/wishlist" className="relative flex h-9 w-9 items-center justify-center 
            rounded-full hover:bg-slate-100">
            <Heart className="h-4 w-4" />
            <span className="absolute -top-1 -right-1 h-4 w-4 flex items-center justify-center 
              rounded-full bg-black text-white text-[10px]">0</span>
          </Link>
          ...
          {!isLoggedIn ? (
            ...
            <div className="relative group hidden md:block">
              <button className="flex items-center gap-2 rounded-full border border-slate-200 
              ...
              <div className="invisible absolute right-0 mt-2 w-44 rounded-xl border border-slate-100 
                bg-white opacity-0 shadow-xl transition-all group-hover:visible 
                group-hover:opacity-100 z-50">
                <Link to="/account" className="block px-4 py-2 hover:bg-slate-50">Account</Link>
                <Link to="/orders" className="block px-4 py-2 hover:bg-slate-50">Orders</Link>
                <Link to="/payments" className="block px-4 py-2 hover:bg-slate-50">Payment</Link>
                <Link to="/address" className="block px-4 py-2 hover:bg-slate-50">Address</Link>
                <button
      ...
      {mobileOpen && (
        <div className="border-t bg-white md:hidden relative z-50">
          <div className="flex flex-col px-4 py-3 text-sm">
            ...
            <Link to="/recommended" className="py-2">Made for You</Link>
            ...
            {!isLoggedIn ? (
              ...
              <div className="mt-3 border-t pt-3">
                <p className="text-xs font-semibold text-slate-500 mb-1">Account</p>
                <Link to="/account" className="block py-1">Account</Link>
                <Link to="/orders" className="block py-1">Orders</Link>
                <Link to="/payments" className="block py-1">Payment</Link>
                <Link to="/address" className="block py-1">Address</Link>
                <button
                  onClick={handleLogout}
