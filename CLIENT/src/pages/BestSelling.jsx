  ...
  return (
    <section className="w-full bg-white py-10">
      <div className="max-w-[1350px] mx-auto px-6 relative">
        ...
        <button
          onClick={slideLeft}
          className="absolute left-0 top-[55%] -translate-y-1/2 z-20 bg-white shadow-sm rounded-full p-2 border border-gray-200 hover:shadow-md"
        >
          <ChevronLeft size={20} />
        </button>
        ...
        <button
          onClick={slideRight}
          className="absolute right-0 top-[55%] -translate-y-1/2 z-20 bg-white shadow-sm rounded-full p-2 border border-gray-200 hover:shadow-md"
        >
